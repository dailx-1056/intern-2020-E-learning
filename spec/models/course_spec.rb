...
RSpec.describe Course, type: :model do
  ...
  describe "Associations" do
    ...
    it "has many course_lecture" do
      is_expected.to have_many :course_lecture
    end
  end
  ...
  describe "Scope order by start date" do
